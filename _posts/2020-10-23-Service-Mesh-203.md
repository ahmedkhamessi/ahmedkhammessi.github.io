...
bigimg:
  - "/img/servicemesh/authorization/authorization.jpg": "https://unsplash.com/photos/lmFJOx7hPc4"
...
In our context, We will enforce access rules through Istio policy and make sure that only specific services can perfrom specific actions. 
...
- Authorization policy is decoupled from the authentication mecanisme.
